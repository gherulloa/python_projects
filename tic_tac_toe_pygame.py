"""Tic tac toe game
- The classic tic tac toe game for 2 users.
- A player wins if their symbol gets 3 in a horizontal, vertical or diagonal row.
- If a player wins or there's a draw the game pauses for 10 seconds and resets."""
...
WIDTH = 400
HEIGHT = 400 # Add 100 later to keep the squared dimensions in the board.
